use actix_web::{get, Responder, web::Form, post, HttpResponse, HttpRequest};
use askama::Template;
use cookie::Cookie;
...
static THEME_CONFIG: Lazy<ThemeConfig> = Lazy::new(|| serde_json::from_str(include_str!("../static/style/theme/themes.json")).unwrap());
